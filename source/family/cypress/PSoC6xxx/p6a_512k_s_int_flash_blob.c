...
static const uint32_t CY8C64x5_flash_prog_blob[] = {
    ...
    0x428b1c5bu, 0x4620d3f7u, 0x0000bd30u, 0x1007ffffu, 0x1006fe04u, 0x01211221u, 0x1006fffcu, 0x0007ffffu,
    ...
    0xe7df2200u, 0xffffff00u, 0xffffffffu, 0x0000ffffu, 0x00000000u
};

static const program_target_t CY8C64x5_flash_prog =
    // Main Flash
    {
        ...
        .algo_size = sizeof(CY8C64x5_flash_prog_blob),    // prog_blob size
        .algo_blob = CY8C64x5_flash_prog_blob,            // address of prog_blob
